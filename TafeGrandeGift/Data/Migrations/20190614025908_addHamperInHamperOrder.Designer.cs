...
namespace TafeGrandeGift.Data.Migrations
{
    ...
    [Migration("20190614025908_addHamperInHamperOrder")]
    partial class addHamperInHamperOrder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TafeGrandeGift.Models.Order", b =>
                {
                    ...
                    b.Property<decimal>("TotalWithShipping");
            ...
            modelBuilder.Entity("TafeGrandeGift.Models.OrderHamper", b =>
                {
                    b.Property<int>("OrderHamperId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("OrderHamperId");

                    b.HasIndex("HamperId");

                    b.HasIndex("OrderId");

                    b.ToTable("OrderHamper");
                });
            ...
            modelBuilder.Entity("TafeGrandeGift.Models.OrderHamper", b =>
                {
                    ...
                    b.HasOne("TafeGrandeGift.Models.Order", "Order")
                        .WithMany("OrderedHamper")
